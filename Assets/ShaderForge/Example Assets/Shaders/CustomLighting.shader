...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _OutlineColor ("Outline Color", Color) = (0.9485294,0.620873,0.03487238,1)
...
////// Lighting:
                ...
                float3 finalColor = (attenuation*_LightColor0.rgb*((_Diffuse_var.rgb*_Color.rgb*max(0,dot(lightDirection,normalDirection)))+UNITY_LIGHTMODEL_AMBIENT.rgb+pow(1.0-max(0,dot(_Normals_var.rgb, viewDirection)),pow(max(0,dot(normalDirection,halfDirection)),exp2(((_Gloss*10.0)+1.0))))));
