...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _node_2518 ("node_2518", Color) = (0.9485294,0.620873,0.03487238,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                return fixed4(_node_2518.rgb,0);
            }
            ENDCG
        }
        Pass {
