...
////// Specular:
                ...
                float3 diffuseColor = (_MainTex_var.rgb*_Color.rgb*_Color.a); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float3 diffColor = (_MainTex_var.rgb*_Color.rgb*_Color.a);
                float specularMonochrome;
                float3 specColor;
