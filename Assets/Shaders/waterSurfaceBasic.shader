    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_161 = saturate(( _node_8887_var.rgb > 0.5 ? (1.0-(1.0-2.0*(_node_8887_var.rgb-0.5))*(1.0-_node_8887_copy_var.rgb)) : (2.0*_node_8887_var.rgb*_node_8887_copy_var.rgb) ));
                float3 normalLocal = (node_5430-node_161);
