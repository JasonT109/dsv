...
////// Lighting:
                ...
                float3 node_5228 = (((tex2D( _GrabTexture, float2(__screenU,(__offset+__screenV))).rgb+tex2D( _GrabTexture, float2((__screenU+__offset),__screenV)).rgb+tex2D( _GrabTexture, float2(__screenU,(__offset-__screenV))).rgb+tex2D( _GrabTexture, float2((__screenU-__offset),__screenV)).rgb)+(tex2D( _GrabTexture, (node_7944+node_634)).rgb+tex2D( _GrabTexture, (node_7944-node_634)).rgb+float3(float2((__screenU+node_7194),(node_7194-__screenV)),0.0)+float3(float2((node_1694-__screenU),(node_1694+__screenV)),0.0))+tex2D( _GrabTexture, __screenUV).rgb)/9.0);
                float3 finalColor = node_5228;
