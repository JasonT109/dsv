...
////// Emissive:
                ...
                float3 finalColor = emissive + (node_5260*_Brightness*((lerp(_TintColor.rgb,_GradientColor2.rgb,(i.screenPos.r-(i.posWorld.r*0.005+0.5)))*0.5+0.0)+(step((sin((node_8817.r*_ChevronAmount*6.28318530718))*0.5+0.5),0.5)*_ChevronStrength)));
