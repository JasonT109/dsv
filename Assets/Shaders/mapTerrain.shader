...
/////// Diffuse:
                ...
                float3 diffuseColor = ((pow(1.0-max(0,dot(normalDirection, viewDirection)),2.0)*_LineColor.rgb*0.5)+(lerp((node_9328_if_leA*node_5927)+(node_9328_if_leB*(node_2774+node_2938)),node_5927,node_9328_if_leA*node_9328_if_leB)*_MapEdgeAlpha_var.rgb));
