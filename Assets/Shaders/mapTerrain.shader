...
Shader "Shader Forge/mapTerrain" {
    Properties {
        ...
        _PosScale ("PosScale", Vector) = (0,0,8,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_6579 = clamp(_PosScale.b,1.0,8.0);
                float2 node_8972 = (i.uv0*node_6579);
                float node_5431 = 0.5;
                float2 node_7943 = (lerp((node_8972+_PosScale.r*float2(0,0.75)),(node_8972+_PosScale.g*float2(0.75,0)),0.5)+(((-1*node_6579)*node_5431)+node_5431));
                float4 _ClippingMask_var = tex2D(_ClippingMask,TRANSFORM_TEX(node_7943, _ClippingMask));
