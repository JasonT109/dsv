...
/////// Diffuse:
                ...
                float node_5937 = (node_4040*_Gradient);
                float3 node_2774 = lerp(_LoColor.rgb,_HiColor.rgb,node_5937);
                ...
                float node_936 = 0.5;
                float3 node_2938 = (lerp(_LineColor.rgb,_LineColorHi.rgb,(1.0 - node_5937))*((1.0 - (smoothstep( node_5683, node_746, frac((node_4040*_Levels)) )*smoothstep( node_5683, node_746, frac((node_4040*(_Levels*(-1.0)))) )))*((step(node_1762,node_8168)+node_936)*(step((_Separation-0.1),node_8168)+node_936))));
                float3 node_5927 = (node_2774-node_2938);
                float4 _MapEdgeAlpha_var = tex2D(_MapEdgeAlpha,i.uv0);
                float3 diffuseColor = (lerp((node_9328_if_leA*node_5927)+(node_9328_if_leB*(node_2774+node_2938)),node_5927,node_9328_if_leA*node_9328_if_leB)*_MapEdgeAlpha_var.rgb);
