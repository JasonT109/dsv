...
namespace Meg.DCC
{
    public class DCCScreenContentPositions : MonoBehaviour {
        ...
        public static Vector3[] screenPositions = 
        {
            ...
            new Vector3(-0.42f, 0.57f, 10f),    //6 screenPos1
            new Vector3(0.31f, 0.25f, 10f),     //7 screenPos2
            new Vector3(-0.5f, -0.37f, 10f),    //8 screenPos3
            new Vector3(0, 0, 10f)              //9 center
        };
        ...
        public static Vector2[] screenScales = 
        {
            ...
            new Vector2(161.5f, 90.84375f),     //6 screenPos1
            new Vector2(161.5f, 90.84375f),     //7 screenPos2
            new Vector2(161.5f, 90.84375f),     //8 screenPos3
            new Vector2(161.5f, 90.84375f)      //9 center
        };
        ...
        public static Vector3 GetScreenPosition(DCCScreenContentPositions.positionID id)
        {
            ...
            switch (id)
                ...
                case positionID.screenPos3:
                    ...
                    break;
                case positionID.center:
                    position = screenPositions[9];
                    break;
            }
