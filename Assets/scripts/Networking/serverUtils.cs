...
namespace Meg.Networking
{
    public class serverUtils : MonoBehaviour
    {
        ...
        public static DCCScreenData DCCScreenData
        {
            get
            {
                if (!_DCCScreenControl && ServerObject)
        ...
        public static void PostVesselDescription(int id, string value)
        {
            if (LocalPlayer)
                LocalPlayer.PostVesselDescription(id, value);
        }
        ...
        public static void PostVesselIconScale(int id, float value)
        {
            if (LocalPlayer)
                LocalPlayer.PostVesselIconScale(id, value);
        }

        /** Post vessel's label style to the server. */
        public static void PostVesselLabel(int id, vesselData.Label label)
        {
            if (LocalPlayer)
                LocalPlayer.PostVesselLabel(id, label);
        }
